...
class ObjectivesControllerTest < ActionController::TestCase
  ...
  test "should create objective" do
    assert_difference('Objective.count') do
      post :create, objective: { amount: @objective.amount, details: @objective.details, monthly_amount: @objective.monthly_amount, name: @objective.name, time: @objective.time }
    end
  ...
  test "should update objective" do
    patch :update, id: @objective, objective: { amount: @objective.amount, details: @objective.details, monthly_amount: @objective.monthly_amount, name: @objective.name, time: @objective.time }
    assert_redirected_to objective_path(assigns(:objective))
  end
