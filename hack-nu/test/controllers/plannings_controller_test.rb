...
class PlanningsControllerTest < ActionController::TestCase
  ...
  test "should create planning" do
    assert_difference('Planning.count') do
      post :create, planning: { category: @planning.category, name: @planning.name, subcategory: @planning.subcategory, value: @planning.value }
    end
  ...
  test "should update planning" do
    patch :update, id: @planning, planning: { category: @planning.category, name: @planning.name, subcategory: @planning.subcategory, value: @planning.value }
    assert_redirected_to planning_path(assigns(:planning))
  end
